...
public class SwipeActivity2 extends Fragment implements OnClickListener,
		OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> adp, View listview, int position,
		...
		//	itm.set_selected(!itm.get_selected());
			...
			Toast.makeText(SwipeActivity2.this.getActivity(), "current:" +position , Toast.LENGTH_SHORT).show();
	...
	// init   
		private void init() {
		    ...
		    DB =  new  DBAdapter(SwipeActivity2.this.getActivity(), "D");
			...
			gdriveModel =new GDriveModel(SwipeActivity2.this.getActivity(), "diary_app", "D", new String[]{"Entry"});	
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.btn_love) {
			...
			// load  layout
			LayoutInflater inflater = (LayoutInflater) SwipeActivity2.this.getActivity()
			...
			//pop dialog
			new AlertDialog.Builder(SwipeActivity2.this.getActivity(),0x00000003) 
					.setTitle("Edit Item") 
							...
							new DialogInterface.OnClickListener() {
								public void onClick(
									...
									if (str == null || str.equals("")) {
										...
										Toast.makeText(SwipeActivity2.this.getActivity(),
	...
	public void syncData2UI(int period) {
		...
		TimerTask task = new TimerTask() {
			@Override
			public void run() {
				Cursor cursor = gdriveModel.DB.getReadableDatabase().
						query("Entry", new String[]{"rowID","text","create_time"}, null, null, null, 
								null, "rowID  desc");
				...
				if( SwipeActivity2.this != null){
				  if( SwipeActivity2.this.getActivity() != null){
					  SwipeActivity2.this.getActivity().runOnUiThread(new Runnable()  
					    {
					        public void run()  
					        {   
					        	if(changeLocal == true){
